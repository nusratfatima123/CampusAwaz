...
import { approveAuthorityRequest, getAuthorityRequest } from '@/lib/authority';
import { canUseIntake } from '@/lib/routing';
import type { RoleName } from '@/types/database';

/**
 * POST /api/authority/admin/requests/[id]/approve
 * Admin: approve an authority request.
 */
export async function POST(
  ...
  try {
    ...
    const result = await approveAuthorityRequest(id, user.id, reason, request);
    ...
    console.error('[authority/admin/requests/[id]/approve] POST failed:', message);
