...
import { SlaReferenceTable } from '@/components/admin/SlaReferenceTable';
...
export default async function AdminDashboardPage() {
  ...
  const heading = isAdminUser ? 'Admin Dashboard' : 'My Assigned Cases';
  const subtitle = isAdminUser
    ? `${profile.universities?.name ?? 'Your university'} — Overview of all complaints`
    : `${profile.universities?.name ?? 'Your university'} — Complaints assigned to you`;
